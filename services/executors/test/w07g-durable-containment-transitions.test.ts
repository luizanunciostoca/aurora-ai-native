...
import type { DurableContainmentStateRecord, DurableContainmentStateSource } from '../src/failure-containment/durable-containment-state.js';
import {
...
class FakeStore implements DurableContainmentWritePort {
  ...
  compareAndSet(input: DurableContainmentCompareAndSetRequest): DurableContainmentCompareAndSetResult {
