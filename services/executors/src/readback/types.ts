...
export type ReceiptCreationReason =
  ...
  | 'RECEIPT_VERIFIED_REQUIRES_EVIDENCE';
...
export interface ReadbackAssessment {
  ...
  /** true/false only describes deterministic comparison; null means comparison was impossible. */
  readonly observedStateMatchesExpected: boolean | null;
  /** Evidence provenance/integrity is still UNVERIFIED at this leaf; VERIFIED cannot be claimed here. */
