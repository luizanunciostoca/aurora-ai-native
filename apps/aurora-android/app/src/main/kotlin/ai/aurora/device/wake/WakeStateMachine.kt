...
class WakeStateMachine(
    ...
    companion object {
        private val allowedTransitions: Map<WakeState, Set<WakeState>> = mapOf(
            WakeState.DISABLED to setOf(WakeState.INITIALIZING),
            WakeState.INITIALIZING to setOf(
                WakeState.ARMED,
                WakeState.PERMISSION_REQUIRED,
                WakeState.PRIVACY_BLOCKED,
                WakeState.AUDIO_ROUTE_UNAVAILABLE,
            ...
            WakeState.HOTWORD_LISTENING to setOf(
            ...
            WakeState.HOTWORD_CANDIDATE to setOf(WakeState.HOTWORD_CONFIRMED, WakeState.HOTWORD_LISTENING),
            WakeState.HOTWORD_CONFIRMED to setOf(WakeState.AWAKEN, WakeState.COOLDOWN, WakeState.DISABLED),
            WakeState.AWAKEN to setOf(WakeState.UTTERANCE_LISTENING, WakeState.COOLDOWN, WakeState.DISABLED),
            WakeState.UTTERANCE_LISTENING to setOf(WakeState.PROCESSING, WakeState.COOLDOWN, WakeState.DISABLED),
            WakeState.PROCESSING to setOf(WakeState.RESPONDING, WakeState.COOLDOWN, WakeState.DISABLED),
