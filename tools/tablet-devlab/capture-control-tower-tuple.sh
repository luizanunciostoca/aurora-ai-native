...
ANDROID_SHA="${AURORA_ANDROID_SHA:-ccffbfc0b722ac7871ee24f8d2c03e2cf522c6f6}"
HOST_SHA="${AURORA_HOST_SHA:-7d9c9bebb8d12b00b8e0629387edd483e14638b6}"
PACKAGING_SHA="${AURORA_PACKAGING_HEAD_SHA:-76e09ea514276556e845d2bb301087aa460fe915}"
PACKAGING_BRANCH="prototype/w15j-physical-apk-artifact"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-35014031636}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10414677915}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-tablet-loopback-apk-ccffbfc0-host-7d9c9beb}"
ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-078cca0cea33e1e68f5fb8e6e3a56cc5d7dda6197fb219dd0550aa854f3cb762}"
APK_SHA="${AURORA_APK_SHA256:-b610bb99892345cd67ff0f5356547b1ca6041aecab10cf6ff93dc9f1f739ff6b}"
