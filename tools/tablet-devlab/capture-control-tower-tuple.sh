...
ANDROID_SHA="${AURORA_ANDROID_SHA:-1b9abd6d75ec0a0eceb3884ee9f101a1885b7889}"
HOST_SHA="${AURORA_HOST_SHA:-a7903e255c00b074fb6c3ba210a69c8296b315e5}"
PACKAGING_SHA="${AURORA_PACKAGING_HEAD_SHA:-752a4f54425ae177cbb664bf731d761e475b2fd1}"
PACKAGING_BRANCH="prototype/w15j-physical-apk-artifact"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-35130207035}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10461800110}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-v017r5-presign-apk-1b9abd6d-host-a7903e25}"
ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-65185fcb7a1e8a798929f3a272d9bcc4548ec3daf7f9d84b93e1583e2154a4de}"
PRESIGN_SHA="${AURORA_PRESIGN_APK_SHA256:-952e9e4687bfd4e3ebadd5b1f2ab2f36779881c1549fe1eb7d68bd95012f8a87}"
APK_SHA="${AURORA_APK_SHA256:-80b5baeccd6853d97af23d4cee3477a0828f35bc30ae418bed267c81dac352b6}"
