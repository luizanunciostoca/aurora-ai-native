...
ANDROID_SHA="${AURORA_ANDROID_SHA:-182743a9284129e7e98a91349428cf020da88f36}"
HOST_SHA="${AURORA_HOST_SHA:-611d2b9e2eb879a54860753833f113d9ed6ac997}"
PACKAGING_SHA="${AURORA_PACKAGING_HEAD_SHA:-26365988daed922c273fc227e2a6376b50bd8a18}"
...
ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-5a31ba71281b5222b51049752e3f1cc44fc24ebda4959055b100d16b2326bf43}"
APK_SHA="${AURORA_APK_SHA256:-500a79a98324df19c8b9baf3feec8daba13ae7982a9454ba6ed18ea85b4ad43e}"
