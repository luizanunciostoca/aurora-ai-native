...
ANDROID_SHA="${AURORA_ANDROID_SHA:-1e8c04d301ce76c60b0f8a47b6ae5866b1c5cd71}"
HOST_SHA="${AURORA_HOST_SHA:-611d2b9e2eb879a54860753833f113d9ed6ac997}"
PACKAGING_SHA="${AURORA_PACKAGING_HEAD_SHA:-560ee2bfd9e8c636dfe3e4c6a9604d51fcef3cda}"
...
ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-454561e20b5e2d382055d5be7c4410b87195bc50f2ac8b907c951f4fba709082}"
APK_SHA="${AURORA_APK_SHA256:-357e5e7992abe9f211a4de080fcc9342f34422589e8dd7b82c78a1c42772a431}"
