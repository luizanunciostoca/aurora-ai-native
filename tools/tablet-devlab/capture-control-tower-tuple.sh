...
PACKAGING_SHA="${AURORA_PACKAGING_HEAD_SHA:-d4afbb5ce2af375bdc8b9ce1d9bb5f1334fefb9d}"
...
ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-a9424ba840aefd4111b777bab0b7d30605139bae94f8424233146067bf9f9f88}"
APK_SHA="${AURORA_APK_SHA256:-0b7fb1210068d05d16d10242cd9b9c46ac32254423d3a7d824d49ea0e2cd2b35}"
