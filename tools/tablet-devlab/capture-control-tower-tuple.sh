...
ANDROID_SHA="${AURORA_ANDROID_SHA:-e156668c0b5214aac0a38ef5738dace65656b675}"
HOST_SHA="${AURORA_HOST_SHA:-df17c9f27a8206f8296f55aa3830667f4742b062}"
PACKAGING_SHA="${AURORA_PACKAGING_HEAD_SHA:-bff72f7e719dcd29c7b7538a91a680c1fa33f060}"
PACKAGING_BRANCH="prototype/w15j-physical-apk-artifact"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-35145610779}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10467107473}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-v017r7-presign-apk-e156668c-host-df17c9f2}"
ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-c21aa967e634e82e999619cc2cda515c36a0202a570a00d8c49779b7e8e7e31e}"
PRESIGN_SHA="${AURORA_PRESIGN_APK_SHA256:-ba85d4bce67ceca6a9048ae028a9a83ca5ef2850eb4523ef04454a6b909ecde5}"
APK_SHA="${AURORA_APK_SHA256:-4a9b7485045e94f5e1f729c7b0a876bbb0869b5bd0c5c6535a1ba436c56d11ca}"
