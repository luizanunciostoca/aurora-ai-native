...
MAIN_SHA="${AURORA_MAIN_SHA:-a5af41c57ef08179197c7a94646bcd59af8eb5e1}"
ANDROID_SHA="${AURORA_ANDROID_SHA:-4de5530a6f8b166b016b7d5dc547c38920f31f10}"
HOST_SHA="${AURORA_HOST_SHA:-c302e03ea44a06b9b13a9e837d14720bde5b505c}"
PACKAGING_SHA="${AURORA_PACKAGING_HEAD_SHA:-d36369f387ea06332f29073713556c4f793defcb}"
...
ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-564eb61eb4e969a4b0e714d3d6acfd99f11f99afb93090cffd3a1d3b8b636bdb}"
APK_SHA="${AURORA_APK_SHA256:-20cfeeec3406ee3c414e43ffd53cb62c0874743f7650fef5d465807a56877e66}"
