...
ANDROID_SHA="${AURORA_ANDROID_SHA:-9bac07fb7ae670ac3eac7d81fc8d6e42ed25ac50}"
HOST_SHA="${AURORA_HOST_SHA:-7d9c9bebb8d12b00b8e0629387edd483e14638b6}"
PACKAGING_SHA="${AURORA_PACKAGING_HEAD_SHA:-a810ced443658460ef61ca5e03ae414b2e47ea90}"
...
ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-fd4e685713e3009495f77e742563a780bcc82520dbda73c75f04fbc71002430d}"
APK_SHA="${AURORA_APK_SHA256:-e51e6516f1c70a766c23eaf55dbd61671bdbfdd9cf71291d5fba16071c7b301c}"
