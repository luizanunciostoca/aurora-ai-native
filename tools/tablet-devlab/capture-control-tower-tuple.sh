...
PACKAGING_SHA="${AURORA_PACKAGING_HEAD_SHA:-f6094d91433952f0b3093319404259bd66c55326}"
PACKAGING_BRANCH="${AURORA_PACKAGING_BRANCH:-prototype/w15j-physical-apk-artifact}"
...
ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-30c83362b15a066a6eb94c5876380506392e3ab29ff91ea9eae35399dcb03eb0}"
PRESIGN_SHA="${AURORA_PRESIGN_APK_SHA256:-27e4e18cb79b8bb90b77a64ea3a2c995417eb359bb02f789b0da68dc48285ed6}"
