...
PACKAGING_HEAD_SHA="${AURORA_PACKAGING_HEAD_SHA:-560ee2bfd9e8c636dfe3e4c6a9604d51fcef3cda}"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-34925593612}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10379413734}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-tablet-loopback-apk-1e8c04d3-host-611d2b9e}"
EXPECTED_ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-454561e20b5e2d382055d5be7c4410b87195bc50f2ac8b907c951f4fba709082}"
EXPECTED_APK_SHA="${AURORA_APK_SHA256:-357e5e7992abe9f211a4de080fcc9342f34422589e8dd7b82c78a1c42772a431}"
EXPECTED_ANDROID_SHA="${AURORA_ANDROID_SHA:-1e8c04d301ce76c60b0f8a47b6ae5866b1c5cd71}"
