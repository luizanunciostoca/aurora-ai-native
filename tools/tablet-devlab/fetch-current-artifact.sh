...
PACKAGING_HEAD_SHA="${AURORA_PACKAGING_HEAD_SHA:-f81b1d767bb4baa9eca5251cc2d689b8fd27ae65}"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-35279807640}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10522415704}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-v017r11-presign-apk-fb05c788-host-df17c9f2}"
EXPECTED_ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-4acfb419457ca0f392b41a59583d3110600e63449d089b3b17ead1b2d8c15afe}"
EXPECTED_PRESIGN_APK_SHA="${AURORA_PRESIGN_APK_SHA256:-a813d5eb389b171a28a944bf93c65c98031cd6945685c942900ef856d7c6d88d}"
EXPECTED_FINAL_APK_SHA="${AURORA_APK_SHA256:-656cf37367e74fcfa38a7af587dc9d1b0cdc0097d18f5bdbeb83d7e9fce85dc4}"
EXPECTED_CERT_SHA="${AURORA_PHYSICAL_SIGNER_CERT_SHA256:-e1745e3d3940fc6b03aef0b609d43aa8c436901965966087c2366108ffe263fb}"
EXPECTED_ANDROID_SHA="${AURORA_ANDROID_SHA:-fb05c7880667d6f179648043e6f1e7b966734134}"
EXPECTED_HOST_SHA="${AURORA_HOST_SHA:-df17c9f27a8206f8296f55aa3830667f4742b062}"
