...
PACKAGING_HEAD_SHA="${AURORA_PACKAGING_HEAD_SHA:-a810ced443658460ef61ca5e03ae414b2e47ea90}"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-34940977508}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10385377274}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-tablet-loopback-apk-9bac07fb-host-7d9c9beb}"
EXPECTED_ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-fd4e685713e3009495f77e742563a780bcc82520dbda73c75f04fbc71002430d}"
EXPECTED_APK_SHA="${AURORA_APK_SHA256:-e51e6516f1c70a766c23eaf55dbd61671bdbfdd9cf71291d5fba16071c7b301c}"
EXPECTED_ANDROID_SHA="${AURORA_ANDROID_SHA:-9bac07fb7ae670ac3eac7d81fc8d6e42ed25ac50}"
