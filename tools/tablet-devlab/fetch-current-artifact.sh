...
PACKAGING_HEAD_SHA="${AURORA_PACKAGING_HEAD_SHA:-003f75c8b81ca0819fcc14e5f27191ef7979cbae}"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-35034459607}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10422099082}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-v017-presign-apk-40246031-host-7d9c9beb}"
EXPECTED_ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-bd316bbc0e31297e898aafee0b8884e01fe852b3d54978ad7c1b85bb5f335e11}"
EXPECTED_PRESIGN_APK_SHA="${AURORA_PRESIGN_APK_SHA256:-5c80079a0f13b13a649df3492e0a1364eae5fa7f343f8bf2defef08920996e4d}"
...
EXPECTED_ANDROID_SHA="${AURORA_ANDROID_SHA:-40246031b2e1b1ef8e232db4d4d2ea6687f8ecf7}"
