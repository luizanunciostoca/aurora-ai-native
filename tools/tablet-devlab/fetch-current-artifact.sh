...
PACKAGING_HEAD_SHA="${AURORA_PACKAGING_HEAD_SHA:-dda8383285e14e38d2d81a21e562d3001391c37a}"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-34945188782}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10387665057}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-tablet-loopback-apk-95aa7bdd-host-7d9c9beb}"
EXPECTED_ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-c50442019f011ae0edffa09ce1168437e5c5a79c7f2e15d3e65810afab76e884}"
EXPECTED_APK_SHA="${AURORA_APK_SHA256:-a8368b6ce184d547198b0132cd35631f5099b0b09a8b3fc16dae6883c1e75826}"
