...
PACKAGING_HEAD_SHA="${AURORA_PACKAGING_HEAD_SHA:-f6094d91433952f0b3093319404259bd66c55326}"
EXPECTED_PACKAGING_BRANCH="${AURORA_PACKAGING_BRANCH:-prototype/w15j-physical-apk-artifact}"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-35529091939}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10611026314}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-v017r12-presign-apk-e42ea065-host-790049ae}"
EXPECTED_ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-30c83362b15a066a6eb94c5876380506392e3ab29ff91ea9eae35399dcb03eb0}"
EXPECTED_PRESIGN_APK_SHA="${AURORA_PRESIGN_APK_SHA256:-27e4e18cb79b8bb90b77a64ea3a2c995417eb359bb02f789b0da68dc48285ed6}"
