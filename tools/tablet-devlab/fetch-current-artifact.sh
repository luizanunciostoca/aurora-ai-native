...
PACKAGING_HEAD_SHA="${AURORA_PACKAGING_HEAD_SHA:-2ac82a2fa4287185b2b3ccb8f785b26ee7122ef1}"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-34948029045}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10388470638}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-tablet-loopback-apk-95aa7bdd-host-7d9c9beb}"
EXPECTED_ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-c44a16f909bac370495466fbdee714eabc3adb07baa08b41db089305e7c0de34}"
EXPECTED_APK_SHA="${AURORA_APK_SHA256:-59310e5c6630328dbc5d0b6b95c426a695e2b8a2ec36497b2c7556483bc6e191}"
EXPECTED_ANDROID_SHA="${AURORA_ANDROID_SHA:-95aa7bddcc041d46c8485c7cf64a7f53ce933a34}"
