...
PACKAGING_HEAD_SHA="${AURORA_PACKAGING_HEAD_SHA:-12231a4070178d12c3812e05fa9e3179aefa68ac}"
...
EXPECTED_ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-2bc3fe221eb36a07146d2a9fb05f505e715c4a52e0b2488a9bc65d1b6cb005d5}"
EXPECTED_APK_SHA="${AURORA_APK_SHA256:-5135a164d551c8f93e0dcfcfdf80ad66b60e69131d51d504ee7c000babbbb993}"
EXPECTED_ANDROID_SHA="${AURORA_ANDROID_SHA:-a45c349c840b6c5125867fee3c7294ad61998cc3}"
