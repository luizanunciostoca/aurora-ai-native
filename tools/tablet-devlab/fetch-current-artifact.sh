...
PACKAGING_HEAD_SHA="${AURORA_PACKAGING_HEAD_SHA:-ebf64ec8b7c09948bb0d4d0f8f63ac70b924dd09}"
RUN_ID="${AURORA_PACKAGING_RUN_ID:-34936090565}"
ARTIFACT_ID="${AURORA_ARTIFACT_ID:-10383194301}"
ARTIFACT_NAME="${AURORA_ARTIFACT_NAME:-aurora-w15j-tablet-loopback-apk-005d77c7-host-7d9c9beb}"
EXPECTED_ZIP_SHA="${AURORA_ARTIFACT_ZIP_SHA256:-638fc86d8b2cbb6975a49d8cded6ead0925d9c39e704c3e1079d39388235a9f9}"
EXPECTED_APK_SHA="${AURORA_APK_SHA256:-1ad8705e00f5ce7223f99838ba783096c43b041da524b1c6fe74694b6f1960db}"
EXPECTED_ANDROID_SHA="${AURORA_ANDROID_SHA:-005d77c73985599e569291c33ff390d8213a0930}"
