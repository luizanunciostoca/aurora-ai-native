...
const linkedToolingPackage = path.join(
  repoRoot,
  'node_modules',
  '@aurora',
  'workspace-tools',
...
if (!fs.existsSync(linkedToolingPackage)) {
  console.error(
    '[workspace] ERROR: npm workspace link for @aurora/workspace-tools was not installed. Run npm ci with the canonical npm version.',
  );
  process.exit(1);
}
