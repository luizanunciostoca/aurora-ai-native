...
const parallel = selectSafeReadyFrontier(
  [
    { issue: { number: 2 }, task: { ...tasks[1], wave: 'W03', laneHint: 'LANE-1' } },
    { issue: { number: 3 }, task: { ...tasks[2], wave: 'W03', laneHint: 'LANE-2' } },
  ],
  tasks,
  2,
);
...
const criticalPathFirst = selectSafeReadyFrontier(
  [
    {
      issue: { number: 10 },
      task: { id: 'SHORT', wave: 'W04', dependsOn: [], sharedWriteSurfaces: [] },
    },
    {
      issue: { number: 11 },
      task: { id: 'LONG', wave: 'W04', dependsOn: [], sharedWriteSurfaces: [] },
    },
  ],
  [
    { id: 'SHORT', dependsOn: [] },
