...
function parseNonEmptyBranded(value, label) {
...
const dependencies = {
  ...
  decisionId: { parse: (value) => parseNonEmptyBranded(value, 'decisionId') },
  policyTokenId: {
    parse: (value) => parseNonEmptyBranded(value, 'policyTokenId'),
  },
  actor: {
    parse: (value) => {
  ...
  version: { parse: (value) => parseNonEmptyBranded(value, 'version') },
};
const OwnerDecisionValidator = index_1.OwnerDecisionSchema.create(dependencies);
const PolicyTokenValidator = index_1.PolicyTokenSchema.create(dependencies);
...
function policyToken(overrides = {}) {
  return {
    kind: 'POLICY_TOKEN',
    schemaVersion: '1.0.0',
