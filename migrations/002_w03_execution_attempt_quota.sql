...
COMMENT ON COLUMN w03_execution_attempt_quota.execution_ref IS 'Opaque server-assigned execution context reference, bounded to 256 safe characters; not an Aurora canonical ID namespace.';
